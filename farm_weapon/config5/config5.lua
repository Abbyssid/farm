...
config5.start = { -456.25, -1684.39, 19.01 } ---ONDE INICIA A ROTA

-- PERMISSAO PARA PODER COLETAR
config5.permission = "manager.permissao"  ----PERMI DO BLIP

-- LOCALIZAÇÃO DA COLETA DOS PACOTES
config5.locs = { ---CDS DOS LOCAIS 
...
config5.itens = { "placa-metal", "molas", "gatilho"} ---MUDAR AQUI
